        ...
        <>
            ...
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>{t('Device Configuration Monitoring')}</span>
                </li>
                </Link>
            </ul>
            </div>
            <FormMonitoringConfigRouterWDCP IDReport="Monitoring Config Device"
                                    url={`ws://${themeConfig.host}:${themeConfig.port_listener}/sock/v1/SettingRouter/:MonitoringDevice?Token=${Token}`}
                                    station={"RBWDCP"} />
        </>
    )
};
