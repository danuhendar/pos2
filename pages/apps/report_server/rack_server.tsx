    ...
    return(
        <>
            ...
            <ul className="flex space-x-2 rtl:space-x-reverse">
                <li>{t('Report')}</li>
                <Link href="/apps/report_ruang_server/rack_server/" className="text-primary hover:underline">    
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                <span>{t('Server Room')} / {t('Rack Server')}</span>
                </li>
                </Link>
            </ul>
            </div>
            <FormMonitoringRuangServer IDReport="Report Rack Server"
